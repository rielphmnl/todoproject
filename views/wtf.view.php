...
<html>
	...
	<body class="h-screen bg-gray-900">
		...
		<div class="h-screen">
			<!-- nav bar -->
			<div class="flex justify-between px-10 py-7 text-gray-50 text-sm font-medium">	
				<div class="">
					<p>[ LOGO ]</p>
				</div>
		...
		<div class="h-screen mt-60 flex flex-col items-center">
			...
			<!-- bullets -->
			<div class="text-gray-50 mt-24 bg-gray-900 h-full w-full flex flex-wrap p-10">
		...
		<div class="px-10">
			<div class="flex justify-between border-t border-gray-800 py-30">
				<!-- left pane -->
				<div class="bg-indigo-700 h-20 w-20">
					<p>[LOGO]</p>
				</div>
